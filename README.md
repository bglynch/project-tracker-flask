...
I resolved any HTML validation isssues were I felt it made sense to resolve them.  
There are some validation errors/warnings that are unresloved on the project page
...
I used [Heroku](https://www.heroku.com/) to deploy this project. Heere is a list of steps I followed to deploy a production version of my app  
...
5. I was using a .bashrc file to store my local enviornment variables. For deployment I added these enviornment variables to Heroku settings Config vars.  
6. I connected this app to my project-tracker github repository.  
7. I triggered a manual build for the initial deployment of my heroku app and tested this new deployed version
